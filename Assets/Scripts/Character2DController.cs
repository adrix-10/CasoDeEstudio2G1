...
public class Character2DController : MonoBehaviour
{
    ...
    //AGREGARLE HEALTH CONTROLLER AL PLAYER Y CUANDO UN ENEMIGO LO TOCA QUITARLE 5% DE VIDA (35 PTS)
    ...
    void HandleMove()
    {
        ...
        // Crea el vector de dirección y asigna la velocidad
    ...
    /// <summary>
    /// Gira el personaje de izq a der o viceversa cuando está en movimiento
    /// </summary>
    ...
    void HandleFlipX()
    {
        if (isMoving)
        {
            // Calcula hacia donde está mirando el personaje
    ...
    bool IsGrounded()
    {
        return
            Physics2D.OverlapCapsule
                (groundCheck.position, new Vector2(0.63F, 0.04F),
